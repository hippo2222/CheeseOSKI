...
"[project]/src/components/mednotes/SearchBar.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const SearchBar = ({ placeholder = 'Пошук...', onSearch })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
        ...
        fileName: "[project]/src/components/mednotes/SearchBar.tsx",
        lineNumber: 17,
        columnNumber: 5
    }, this);
};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$mednotes$2f$SearchBar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/mednotes/SearchBar.tsx [app-ssr] (ecmascript)"); // Импортируем компонент строки поиска
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
'use client';
;
;
...
;
;
// Импорт pdfjs только на клиенте, чтобы избежать ReferenceError: DOMMatrix is not defined на сервере
...
const FileTreeView = ({ nodes, onFileSelect, selectedFileId, searchTerm, expandedFolders, toggleFolder })=>{
    ...
    // Рекурсивно получить все файлы (PDF) из дерева
    const getAllFiles = (nodes)=>{
        return nodes.flatMap((node)=>node.type === 'file' ? [
                node
            ] : node.children ? getAllFiles(node.children) : []);
    };
    // Извлечь текст из PDF-файла по URL
    ...
    const handleTextSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (term)=>{
        ...
        const files = getAllFiles(nodes).filter((f)=>f.path && f.path.endsWith('.pdf'));
    ...
    // Фильтрация: если есть результаты поиска по тексту, показываем только их
    const filterNodesBySearchResults = (nodesToFilter)=>{
        if (!searchResults.length) return nodesToFilter;
        function rFilter(array) {
            return array.reduce((acc, node)=>{
                if (node.type === 'file') {
                    if (searchResults.includes(node.id)) acc.push(node);
                } else {
    ...
    const displayedNodes = searchResults.length ? filterNodesBySearchResults(nodes) : nodes;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$scroll$2d$area$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ScrollArea"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SidebarMenu"], {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$mednotes$2f$SearchBar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    placeholder: "Пошук по тексту PDF...",
...
const __TURBOPACK__default__export__ = FileTreeView;
 // В компоненте поиска и обработчике handleTextSearch реализовать поиск по содержимому PDF-файлов, а не по их названиям/пути.
 // Для этого потребуется использовать библиотеку для чтения PDF (например, pdfjs-dist) и реализовать функцию, которая будет открывать PDF, извлекать текст и искать совпадения.
}}),
...
//# sourceMappingURL=src_ada87584._.js.map