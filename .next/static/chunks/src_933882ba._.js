...
const FileTreeView = ({ nodes, onFileSelect, selectedFileId, searchTerm, expandedFolders, toggleFolder })=>{
    ...
    // drag-and-drop state
    const [rootOrder, setRootOrder] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState([]);
    const [liveOrder, setLiveOrder] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FileTreeView.useEffect": ()=>{
            ...
            if (saved) {
                ...
                setRootOrder(nodes.map({
                    "FileTreeView.useEffect": (n)=>n.id
                }["FileTreeView.useEffect"]));
            }
        }
    }["FileTreeView.useEffect"], [
    ...
    const orderedNodes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "FileTreeView.useMemo[orderedNodes]": ()=>{
            const order = liveOrder || rootOrder;
            if (!order.length) return nodes;
            const idToNode = Object.fromEntries(nodes.map({
                "FileTreeView.useMemo[orderedNodes].idToNode": (n)=>[
                        n.id,
                        n
                    ]
            }["FileTreeView.useMemo[orderedNodes].idToNode"]));
            return order.map({
                "FileTreeView.useMemo[orderedNodes]": (id)=>idToNode[id]
            }["FileTreeView.useMemo[orderedNodes]"]).filter(Boolean);
        }
    }["FileTreeView.useMemo[orderedNodes]"], [
        nodes,
        rootOrder,
    ...
    const handleTextSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FileTreeView.useCallback[handleTextSearch]": async (term)=>{
            if (!term.trim()) {
                setSearchResults([]);
    ...
    }["FileTreeView.useCallback[handleTextSearch]"], []);
    ...
    const handleResultClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FileTreeView.useCallback[handleResultClick]": (result)=>{
            setShowDropdown(false);
            setSearchResults([]);
            // Находим FileNode по пути
            const findByPath = {
                "FileTreeView.useCallback[handleResultClick].findByPath": (nodes, path)=>{
            ...
            }["FileTreeView.useCallback[handleResultClick].findByPath"];
            const file = findByPath(nodes, result.path);
            if (file) onFileSelect(file);
        }
    }["FileTreeView.useCallback[handleResultClick]"], [
        nodes,
        onFileSelect
    ]);
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarMenu"], {
            ...
            children: [
                ...
                selectMode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        getSubfolders(orderedNodes).map(({ parent, sub })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    (sub.children || []).filter((f)=>f.type === 'file').map((file)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        ...
                        chosenFiles.length === getSubfolders(orderedNodes).length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-4",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                chosenFiles.map((file)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(FileTreeView, "z299u2/9P37TsxS4dQrWt++w3A4=");
_c1 = FileTreeView;
...
_s(MedNotesHomePage, "X48BkC8R1jsDrCFMKNNk5uYKBbs=", false, function() {
    return [
